 ...
 * 2018-11-18T20:10:39.387+08:00
 * Generated source version: 3.1.17
 * 
 */
@WebServiceClient(name = "HelloWorldService", 
                  wsdlLocation = "http://192.168.0.112/helloWorld?wsdl",
                  targetNamespace = "http://weservice.lyp.com/") 
public class HelloWorldService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://weservice.lyp.com/", "HelloWorldService");
    public final static QName HelloWorldPort = new QName("http://weservice.lyp.com/", "HelloWorldPort");
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.112/helloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.112/helloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
