 ...
 * generated in the com.lyp.weservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRole_QNAME = new QName("http://weservice.lyp.com/", "getRole");
    private final static QName _GetRoleByUser_QNAME = new QName("http://weservice.lyp.com/", "getRoleByUser");
    private final static QName _GetRoleByUserResponse_QNAME = new QName("http://weservice.lyp.com/", "getRoleByUserResponse");
    private final static QName _GetRoleResponse_QNAME = new QName("http://weservice.lyp.com/", "getRoleResponse");
    private final static QName _Say_QNAME = new QName("http://weservice.lyp.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://weservice.lyp.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.lyp.weservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weservice.lyp.com/", name = "getRole")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weservice.lyp.com/", name = "getRoleByUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weservice.lyp.com/", name = "getRoleByUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weservice.lyp.com/", name = "getRoleResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weservice.lyp.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weservice.lyp.com/", name = "sayResponse")
